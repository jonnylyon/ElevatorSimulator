...
namespace ElevatorSimulator.Tools
{
    static class CarMotionMaths
    {
        ...
        public static void CalculateDecisionPointSpeedAndTime(CarAttributes attributes, CarState state, double floorDist, out double nextFloorDecisionPointSpeed, out  double nextFloorDecisionPointTime)
        {
